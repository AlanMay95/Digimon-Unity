       ...
       public static readonly  List<Digimon> AllDigi = new List<Digimon>()
        {
            ...
            (new Digimon("Agumon",Resources.Load<Sprite>("Agumon"), 2, 25, 25, 25, 25, "Koromon", "na", "na")),
            (new Digimon("Armadillomon",Resources.Load<Sprite>("Armadillomon"), 2, 25, 25, 25, 25, "Upamon", "na", "na")),
            (new Digimon("Betamon",Resources.Load<Sprite>("Betamon"), 2, 25, 25, 25, 25, "Bukamon", "Koromon", "na")),
            (new Digimon("Biyomon",Resources.Load<Sprite>("Biyomon"), 2, 25, 25, 25, 25, "Yokomon", "na", "na")),
            (new Digimon("Candlemon",Resources.Load<Sprite>("Candlemon"), 2, 25, 25, 25, 25, "DemiMeramon", "na", "na")),
            (new Digimon("Crabmon",Resources.Load<Sprite>("Crabmon"), 2, 25, 25, 25, 25, "Poyomon", "na", "na")),
            (new Digimon("DemmiDevimon",Resources.Load<Sprite>("DemiDevimon"), 2, 25, 25, 25, 25, "Pagumon", "na", "na")),
            (new Digimon("Elecmon",Resources.Load<Sprite>("Elecmon"), 2, 25, 25, 25, 25, "Tsunomon", "na", "na")),
            (new Digimon("Floramon",Resources.Load<Sprite>("Floramon"), 2, 25, 25, 25, 25, "Tanemon", "na", "na")),
            (new Digimon("Gabumon",Resources.Load<Sprite>("Gabumon"), 2, 25, 25, 25, 25, "Tsunomon", "na", "na")),
            (new Digimon("Gazimon",Resources.Load<Sprite>("Gazimon"), 2, 25, 25, 25, 25, "Pagumon", "na", "na")),
            (new Digimon("Gizamon",Resources.Load<Sprite>("Gizamon"), 2, 25, 25, 25, 25, "Pagumon", "na", "na")),
            (new Digimon("Goblimon",Resources.Load<Sprite>("Goblimon"), 2, 25, 25, 25, 25, "Pagumon", "na", "na")),
            (new Digimon("Gomamon",Resources.Load<Sprite>("Gomamon"), 2, 25, 25, 25, 25, "Bukamon", "na", "na")),
            (new Digimon("Gotsumon",Resources.Load<Sprite>("Gotsumon"), 2, 25, 25, 25, 25, "Pagumon", "na", "na")),
            (new Digimon("Hagurumon",Resources.Load<Sprite>("Hagurumon"), 2, 25, 25, 25, 25, "Kapurimon", "na", "na")),
            (new Digimon("Hawkmon",Resources.Load<Sprite>("Hawkmon"), 2, 25, 25, 25, 25, "Poromon", "na", "na")),
            (new Digimon("Kokuwamon",Resources.Load<Sprite>("Kokuwamon"), 2, 25, 25, 25, 25, "Kapurimon", "na", "na")),
            (new Digimon("Kunemon",Resources.Load<Sprite>("Kunemon"), 2, 25, 25, 25, 25, "Minomon", "na", "na")),
            (new Digimon("Mushroomon",Resources.Load<Sprite>("Mushroomon"), 2, 25, 25, 25, 25, "Tanemon", "na", "na")),
            (new Digimon("Otamamon",Resources.Load<Sprite>("Otamamon"), 2, 25, 25, 25, 25, "Bukamon", "na", "na")),
            (new Digimon("Palmon",Resources.Load<Sprite>("Palmon"), 2, 25, 25, 25, 25, "Tanemon", "na", "na")),
            (new Digimon("Patamon",Resources.Load<Sprite>("Patamon"), 2, 25, 25, 25, 25, "Tokomon", "na", "na")),
            (new Digimon("Penguinmon",Resources.Load<Sprite>("Pemguinmon"), 2, 25, 25, 25, 25, "Bukamon", "na", "na")),
            (new Digimon("Salamon",Resources.Load<Sprite>("Salamon"), 2, 25, 25, 25, 25, "Nyaromon", "na", "na")),
            (new Digimon("Syakomon",Resources.Load<Sprite>("Syakomon"), 2, 25, 25, 25, 25, "Bukamon", "na", "na")),
            (new Digimon("Taprimon",Resources.Load<Sprite>("Tapirmon"), 2, 25, 25, 25, 25, "Tsunomon", "na", "na")),
            (new Digimon("Tentomon",Resources.Load<Sprite>("Tentomon"), 2, 25, 25, 25, 25, "Motimon", "na", "na")),
            (new Digimon("Terriermon",Resources.Load<Sprite>("Terriermon"), 2, 25, 25, 25, 25, "Gummymon", "na", "na")),
            (new Digimon("ToyAgumon",Resources.Load<Sprite>("ToyAgumon"), 2, 25, 25, 25, 25, "Kapurimon", "na", "na")),
            (new Digimon("Veemon",Resources.Load<Sprite>("Veemon"), 2, 25, 25, 25, 25, "DemiVeemonmon", "na", "na")),
            (new Digimon("Wormmon",Resources.Load<Sprite>("Wormmon"), 2, 25, 25, 25, 25, "Minomon", "na", "na")),
